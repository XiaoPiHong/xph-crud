...
import { default as extendsTableBaseRaw } from "!raw-loader!examples/demo/extends/extendsTableBase.tsx";
...
<ExpandDemoWrapper rawStr={extendsFormBaseRaw}>
  <ExtendsFormBase />
</ExpandDemoWrapper>

### 扩展表单项的规范

<ExpandDemoWrapper rawStr={extendsFormItemRaw}>
  <ExtendsFormItem />
</ExpandDemoWrapper>
...
<ExpandDemoWrapper rawStr={extendsTableBaseRaw}>
  <ExtendsTableBase />
</ExpandDemoWrapper>
...
<ExpandDemoWrapper rawStr={extendsActionsBaseRaw}>
  <ExtendsActionsBase />
</ExpandDemoWrapper>
...
<ExpandDemoWrapper rawStr={extendsFormDtsRaw}>
  <ExtendsFormDts />
</ExpandDemoWrapper>
