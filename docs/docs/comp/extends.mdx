...
import { default as extendsTableCellFuncRaw } from "!raw-loader!examples/demo/extends/extendsTableCellFunc.tsx";
...
<CodeBlock language={"tsx"}>{extendsTableCellFuncRaw}</CodeBlock>
